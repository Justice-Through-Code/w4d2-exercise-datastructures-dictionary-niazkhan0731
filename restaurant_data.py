...
def favorite_restaurant():
    ...
    #    }
    favorite_restaurant["name"] = input("Enter the restaurant name: ")
    favorite_restaurant["address"] = input("Enter the restaurant address: ")
    favorite_restaurant["favorite_dish"] = input("Enter your favorite dish at the restaurant: ")
